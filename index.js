...
mongoose
	.connect(
		"mongodb+srv://oussama:ahmadalah2013@myfirstnodejscluster.sbgxtga.mongodb.net/?retryWrites=true&w=majority&appName=MyFirstNodeJsCluster"
	)
	.then(() => {
...
app.get("/display-articles",async (req,res) =>{
    const articles = await Article.find();
